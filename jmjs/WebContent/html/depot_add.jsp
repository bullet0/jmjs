    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <ul class="nav nav-tabs">
                <li>
                    <a href="<%=request.getContextPath() %>/depotController?method=findAllByPage&condition=">数据查询</a>
                </li>
                <li class="active">
        ...
        <div class="row">
            <form id="form1" action="<%=request.getContextPath() %>/depotController?method=add" method="post">
                <div class="form-group col-md-6">
                    <label for="dVarietyNum">品种数量</label>
                    <input type="text" readonly="readonly" class="form-control" name="dVarietyNum" id="dVarietyNum" value="0">
                </div>
                <div class="form-group col-md-6">
                    <label for="dTotalPrice">总价</label>
                    <input type="text" readonly="readonly" class="form-control" name="dTotalPrice" id="dTotalPrice" value="0">
                </div>
                <div class="form-group col-md-6">
                    <label for="dDate">进货日期</label>
                    <div class='input-group date' id="datetimepicker">  
                    	<input type="text" class="form-control" name="dDate" id="dDate" placeholder="请输入进货日期">
