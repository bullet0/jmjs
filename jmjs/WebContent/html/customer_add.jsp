...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <form id="form1" action="<%=request.getContextPath() %>/customerController?method=add" method="post">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="cPhone" id="cPhone" placeholder="请输入公司的座机号码">
                </div>
                <div class="form-group col-md-6">
                    <label for="cAddress">公司地址</label>
                    <input type="text" class="form-control" name="cAddress" id="cAddress" placeholder="请输入公司所在地">
                </div>
                <div class="form-group col-md-6">
                    <label for="cEmail">公司邮箱</label>
                    <input type="text" class="form-control" name="cEmail" id="cEmail" placeholder="请输入企业邮箱">
                </div>
                <div class="form-group col-md-6">
                    <label for="cConName">联系人姓名</label>
                    <input type="text" class="form-control" name="cConName" id="cConName" placeholder="请输入您的姓名">
                </div>
                <div class="form-group col-md-6">
                    <label for="cConMobile">联系人手机号</label>
                    <input type="text" class="form-control" name="cConMobile" id="cConMobile" placeholder="请输入您的手机号">
                </div>
                <div class="form-group col-md-6">
                    <label for="cPostCode">邮编</label>
                    <input type="text" class="form-control" name="cPostCode" id="cPostCode" placeholder="请输入邮编">
                </div>
                <div class="form-group col-md-6">
                    <label for="cAccount">企业银行账号</label>
                    <input type="text" class="form-control" name="cAccount" id="cAccount" placeholder="请输入企业对公账号">
                </div>
                <div class="col-md-12">
                    <hr/>
                    <div class="row">
